class Appointment < ActiveRecord::Base
  ...
  #For Create. Only passes if the friend's email is in the CheckMark database and passes its relationship by add current_user.id
  ...
  #for update. Checks if friend's email exist in the CheckMark database. To delete a friend, add the word 'delete'
  ...
  #Sidekiq for setting up reminders base on user options
